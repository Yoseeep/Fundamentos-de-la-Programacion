...
public class Checkers {
	...
	/**
	 * @param textoRestriccion Mensaje que se incluirá en la excepción elevada
	 * @param condicion        Expresión booleana que ha de cumplirse para que no se
	 *                         eleve una excepci�n
	...
	/**
	 * @param parametros Lista de parámetros para los que se quiere realizar una
