...
public class TestVinotecaBucles {
	...
	public static void main(String[] args) {
		...
		testCalcularNumeroVinosPais(vinos2, "Spain");
		 ...
		 testObtenerVinosRangoPuntos(vinos2, 90, 95); // Caso de prueba para ver si se gestionan bien los parámetros 
		 ...
		 * System.out.println("==========================================");
		 * testObtenerVinosBaratos(vinos1, 10.0); testObtenerVinosBaratos(vinos2, 10.0);
		 * 
		 ...
		 * System.out.println("===============================================");
		 * testObtenerVinoMejorPuntuado(vinos1); testObtenerVinoMejorPuntuado(vinos2);
		 * 
		 ...
		 * System.out.println("=========================================");
		 * testCalcularVinosPorPais(vinos1); testCalcularVinosPorPais(vinos2);
		 * 
		 * System.out.println("\nCasos de prueba para calcularUvasPais");
		 * System.out.println("=====================================");
		 * testAgruparUvasPorPais(vinos1); testAgruparUvasPorPais(vinos2);
		 * 
		 * System.out.
	...
	public static void testConstructor(Collection<Vino> coleccion_vinos) {
	  ...
	  System.out.println("\nTEST de calcularNumeroVinosDePais"); try {
	  System.out.println(String.format("\tHay %d  vinos de %s: ",
	  (vinos).calcularNumeroVinosDePais(pais), pais)); } catch (Exception e) {
	  System.out.println("Excepción inesperada capturada:\n   " + e); } }
	  
	public static void testObtenerVinosRangoPuntos(Vinoteca vinos, Integer inf,
	  Integer sup) { System.out.println("\nTEST de obtenerVinosRangoPuntos"); try {
	  String msg = String.format("\tLos vinos del rango [%d,%d] son", inf, sup);
	  System.out.println(msg); mostrarColeccion((vinos).obtenerVinosRangoPuntos(inf,
	  sup)); } catch (IllegalArgumentException iae) {
	  System.out.println("Excepción capturada: " + iae); } catch (Exception e) {
	  System.out.println("Excepción inesperada capturada:\n   " + e); } }
	  
	/* public static void testCalcularNumeroVinosDePaisConPuntuacionSuperior
	 * (Vinoteca vinos, String pais, Integer umbralPuntuacion) {
	 * System.out.println("\nTEST de calcularNumeroVinosDePaisConPuntuacionSuperior"
	 * ); try { System.out.println(String.
	 * format("\tHay %d  vinos del pais %s con puntuación superior a %d: ",
	 * vinos.calcularNumeroVinosDePaisConPuntuacionSuperior(pais, umbralPuntuacion),
	 * pais, umbralPuntuacion)); } catch (Exception e) {
	 * System.out.println("Excepción inesperada capturada:\n   " + e); } }
	 * 
	 * private static void testObtenerVinosBaratos(Vinoteca vinos, Double precio) {
	 * System.out.println("\nTEST de obtenerVinosBaratos"); try { String msg =
	 * String.format("\tLos vinos del con precio inferior a %.2fson", precio);
	 * System.out.println(msg); mostrarColeccion(vinos.obtenerVinosBaratos(precio));
	 * } catch (Exception e) {
	 * System.out.println("Excepción inesperada capturada:\n   " + e); }
	 * 
	 * }
	 * 
	 * private static void testExisteVinoDeUvaEnRegion(Vinoteca vinos, String uva,
	 * String region) { System.out.println("\nTEST de existeVinoDeUvaEnRegion"); try
	 * { String msg =
	 * String.format("\t¿Hay algún vino de la uva %s en la región %s? %s", uva,
	 * region, vinos.existeVinoDeUvaEnRegion(uva, region)); System.out.println(msg);
	 * } catch (Exception e) {
	 * System.out.println("Excepción inesperada capturada:\n   " + e); }
	 * 
	 * }
	 ...
	 * System.out.println("\nTEST de calcularUvasDeRegion"); try { Set<String> uvas
	 * = vinos.calcularUvasDeRegion(region); String msg =
	 * String.format("\tHay %d uvas de la región %s y son", uvas.size(), region );
	 * System.out.println(msg); uvas.stream() .forEach(uva->System.out.println("\t"+
	 * uva)); } catch (Exception e) {
	 * System.out.println("Excepción inesperada capturada:\n   " + e); } }
	 * 
	 * private static void testCalcularTotalPuntosVinosDeRegion(Vinoteca vinos,
	 * String region) {
	 * System.out.println("\nTEST de calcularTotalPuntosVinosDeRegion"); try {
	 ...
	 * }
	 * 
	 * private static void testCalcularMediaPuntosVinosDeUva(Vinoteca vinos, String
	 * uva) { System.out.println("\nTEST de calcularMediaPuntosVinosDeUva"); try {
	 * String msg =
	 * String.format("\tLa media de puntos de los vinos de la uva %s es %.2f", uva,
	 * vinos.calcularMediaPuntosVinosDeUva(uva)); System.out.println(msg); } catch
	 * (Exception e) { System.out.println("Excepción inesperada capturada:\n   " +
	 * e); } }
	 * 
	 * public static void testObtenerVinoMejorPuntuado(Vinoteca vinos) {
	 * System.out.println("\nTEST de obtenerVinoMejorPuntuado"); try {
	 * System.out.println("\tEl vino mejor puntuado es: " +
	 * vinos.obtenerVinoMejorPuntuado()); } catch (Exception e) {
	 * System.out.println("Excepción inesperada capturada:\n   " + e); } }
	 * 
	 * private static void testObtenerVinoMejorPuntuadoDePais(Vinoteca vinos, String
	 * pais) { System.out.println("\nTEST de obtenerVinoMejorPuntuadoDePais"); try {
	 * System.out.println(String.
	 * format("\tEl vino mejor puntuado del pais %s es: %s", pais,
	 * vinos.obtenerVinoMejorPuntuadoDePais(pais))); } catch (Exception e) {
	 * System.out.println("Excepción inesperada capturada:\n   " + e); }
	 * 
	 * }
	 * 
	 * private static void testObtenerNVinosRegionOrdenadosPrecio(Vinoteca vinos,
	 * String region, Integer n) {
	 * System.out.println("\nTEST de obtenerNVinosRegionOrdenadosPrecio"); try {
	 * String msg = String.format("\tLos %d vinos más caros de la región %s son", n,
	 * region); System.out.println(msg);
	 ...
	 * System.out.println("\nTEST de agruparVinosPorPais"); try {
	 * System.out.println("  Vinos por pais: " );
	 * mostrarMapConColeccion(vinos.agruparVinosPorPais(), 10); } catch (Exception
	 * e) { System.out.println("Excepción inesperada capturada:\n   " + e); } }
	 * 
	 * public static void testAgruparUvasPorPais(Vinoteca vinos) {
	 * System.out.println("\nTEST de agruparUvasPorPais"); try {
	 * System.out.println("Las uvas de cada país son: "); Map<String, Set<String>>
	 * m= vinos.agruparUvasPorPais(); m.entrySet().stream()
	 * .forEach(e->System.out.println("\t"+e)); } catch (Exception e) {
	 * System.out.println("Excepción inesperada capturada:\n   " + e); } }
	 * 
	 * public static void testCalcularCalidadPrecioPorRegionMayorDe(Vinoteca vinos,
	 * Double umbral) {
	 * System.out.println("\nTEST de calcularCalidadPrecioPorRegionMayorDe"); try {
	 * System.out.println(String.
	 * format("\tTotal vinos de calidad/precio mayor de %.1f: \n", umbral) +
	 * "\t"+vinos.calcularCalidadPrecioPorRegionMayorDe(umbral)); } catch (Exception
	 * e) { System.out.println("Excepción inesperada capturada:\n   " + e); } }
	 * 
	 * public static void testCalcularVinoMasCaroPorPais(Vinoteca vinos) {
	 * System.out.println("\nTEST de calcularVinoMasCaroPorPais"); try {
	 * System.out.println(String.format("\tVino más caro por pais: " ) +
	 * "\t"+vinos.calcularVinoMasCaroPorPais()); } catch (Exception e) {
	 * System.out.println("Excepción inesperada capturada:\n   " + e); } }
	 * 
	 * public static void testCalcularNMejoresVinosPorPais(Vinoteca vinos, Integer
	 * n) { System.out.println("\nTEST de calcularNMejoresVinosPorPais"); try {
	 * System.out.println(String.format("\tLos " + n + " mejores vinos por pais: " )
	 * + "\t"+ vinos.calcularNMejoresVinosPorPais(n)); } catch (Exception e) {
	 * System.out.println("Excepción inesperada capturada:\n   " + e); } }
	 * 
	 * public static void testCalcularRegionConMejoresVinos(Vinoteca vinos, Double
	 * umbral) { System.out.println("\nTEST de calcularRegionConMejoresVinos"); try
	 * { System.out.println(String.
	 * format("\tLa región con mejores vinos con una calidad-precio superior o igual a %.1f: \n"
	 * , umbral) + "\t"+ vinos.calcularRegionConMejoresVinos(umbral)); } catch
	 * (Exception e) { System.out.println("Excepción inesperada capturada:\n   " +
	 * e); } }
	 */
}
