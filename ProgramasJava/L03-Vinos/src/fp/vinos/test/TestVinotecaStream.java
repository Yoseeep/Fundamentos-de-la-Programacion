...
public class TestVinotecaStream {
	...
	public static void main(String[] args) {
		...
		Vinoteca vinos2 = FactoriaVinos.leerVinoteca("data/wine_reviews.csv","S");
	...
	public static void testCalcularVinoMasCaroPorPais(Vinoteca vinos) {
		...
		try {
			System.out.println(String.format("\tVino más caro por pais: ") + "\t" + vinos.calcularVinoMasCaroPorPais());
		} catch (Exception e) {
			System.out.println("Excepción inesperada capturada:\n   " + e);
		}
	}
	...
	public static void testCalcularRegionConMejoresVinos(Vinoteca vinos, Double umbral) {
		...
		try {
			System.out.println(
					String.format("\tLa región con mejores vinos con una calidad-precio superior o igual a %.1f: \n",
							umbral) + "\t" + vinos.calcularRegionConMejoresVinos(umbral));
		} catch (Exception e) {
			System.out.println("Excepción inesperada capturada:\n   " + e);
		}
	}
