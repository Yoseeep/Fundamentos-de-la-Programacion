...
public record Vuelo(String codigo, String destino, LocalDateTime fechaHoraSalida, Duration duracion, Double velocidad, Double precio, Integer numeroPlazas, Boolean conEscalas,List<Persona> pasajeros) implements Comparable<Vuelo>{
	...
	public int compareTo(Vuelo o) {
		...
		if (res == 0) {
			...
			if (res == 0) {
				res = fechaHoraSalida.toLocalDate().compareTo(o.fechaHoraSalida.toLocalDate());
			}
		}
		return res;
	}
	...
	public String toString() {
		return "Vuelo [codigo=" + codigo + ", destino=" + destino + ", fechaHoraSalida=" + fechaHoraSalida
				+ ", fechaHoraLlegada=" + fechaHoraSalida.plus(duracion) + ", numeroPlazas=" + numeroPlazas + ", numeroPasajeros=" + pasajeros.size() + "]";
	}
