...
public class TestVuelo01 {
	...
	private static void testConstructor02() {
		try { 
			...
			Vuelo v=new Vuelo("IBE-001","Valencia",LocalDateTime.of(2023,8,1,9,0),Duration.ofMinutes(115),890.5,150d,5,false);
			System.out.println("\t"+v);
			System.out.println("\tConstruido correctamente!!");
		}catch(Exception e) {
			System.out.println("\tHa habido un error al construir el vuelo");
		...
		try {
			System.out.println("\nTest constructor-2 con algún parámetro nulo");
			Vuelo v=new Vuelo(null,"Valencia",LocalDateTime.of(2023,8,1,9,0),Duration.ofMinutes(115),890.5,150d,5,false);
			System.out.println("\t"+v);
		}catch(Exception e) {
			System.out.println("\tHa habido un error al construir el vuelo");
			System.out.println("\t"+e);
		...
		try { 
			System.out.println("\nTest constructor-2 con el código malo");
			Vuelo v=new Vuelo("IBE001","Valencia",LocalDateTime.of(2023,8,1,9,0),Duration.ofMinutes(115),890.5,150d,5,false);
			System.out.println("\t"+v);
			System.out.println("\tConstruido correctamente!!");
		}catch(Exception e) {
			System.out.println("\tHa habido un error al construir el vuelo");
		...
		try { 
			System.out.println("\nTest constructor-2 con la duración negativa");
			Vuelo v=new Vuelo("IBE-001","Valencia",LocalDateTime.of(2023,8,1,9,0),Duration.ofMinutes(-115),890.5,150d,5,false);
			System.out.println("\t"+v);
			System.out.println("\tConstruido correctamente!!");
		}catch(Exception e) {
		...
		try { 
			System.out.println("\nTest constructor-2 con la velocidad negativa");
			Vuelo v=new Vuelo("IBE-001","Valencia",LocalDateTime.of(2023,8,1,9,0),Duration.ofMinutes(115),-890.5,150d,5,false);
			System.out.println("\t"+v);
			System.out.println("\tConstruido correctamente!!");
		}catch(Exception e) {
		...
		try {
			System.out.println("\nTest constructor-2 con el precio negativo");
			Vuelo v=new Vuelo("IBE-001","Valencia",LocalDateTime.of(2023,8,1,9,0),Duration.ofMinutes(115),890.5,-150d,5,false);
			System.out.println("\t"+v);
			System.out.println("\tConstruido correctamente!!");
		}catch(Exception e) {
		...
		try {
			System.out.println("\nTest constructor-2 con las plazas negativas");
			Vuelo v=new Vuelo("IBE-001","Valencia",LocalDateTime.of(2023,8,1,9,0),Duration.ofMinutes(115),890.5,150d,-5,false);
			System.out.println("\t"+v);
			System.out.println("\tConstruido correctamente!!");
		}catch(Exception e) {
